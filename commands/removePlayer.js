...
module.exports = {
  name: 'removePlayer',
  description: 'Command for captains. User must be captain of the team and target must be in that team. Team size must be greater than minimum. Format: .invite ["tourneyName"] ["teamName"] [@player]',
